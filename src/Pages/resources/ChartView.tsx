...
import {Label, LineChart, Line, AreaChart, Area, CartesianGrid, XAxis, YAxis, Tooltip, ReferenceArea, ResponsiveContainer, BarChart} from "recharts";
import useStore, { config, NF, prettyFormat, toDate, toKillo } from "../../useStore";
...
const Chart = ({method, type, title, desc, info, yTipLabel, options}: ChartProps) => {
	...
	// const [data, setData] = React.useState<Array<{name: string, x: number, y: number}>>([])
	...
	return (
		<>
			...
			<div className="panel">
				<div className="panel-header text-align-center">
