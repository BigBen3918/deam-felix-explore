...
import useStore, { config, ellipsis, NF, prettyFormat, prettyPrint } from '../../../useStore'
				...
				<div className='h4 d-middle gap' style={{marginBottom: 20}}>
					{type==="address" && (
						<>
							...
							<span onClick={()=>setStatus({...status, showQRCode: true})} className='btn btn-icon cmd'><Icons.QRCode/></span>
						</>
					)}
					{type==="token" && (
						<>
