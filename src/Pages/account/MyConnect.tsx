			...
			>
				<div className="panel">
					...
					<div className="panel-content list">
						...
						<div>
							<span className="d-middle">
								<Icons.AddressCard className="mr" />
								Public Profile:
							</span>
							<span>
								<Link className="btn btn-outline-primary" to={`/profile/${status.userId}`}>View public profile page<Icons.External className="ml" /></Link>
							</span>
						</div>
						<div>
							<span className="d-middle">
								<Icons.Badge className="mr" />
								Public Profile Name:
							</span>
							<span>
								<div>
									<input className="input input-block mb" placeholder="Pullic user profile name" />
									<small className="gray"><Icons.Info className="mr" size={11} />Your PUBLIC Profile information can be viewed publicly. Please do not enter sensitive information like your private keys here.</small>
								</div>
							</span>
						</div>
						<div>
							<span className="d-middle">
								<Icons.Globe className="mr" />
