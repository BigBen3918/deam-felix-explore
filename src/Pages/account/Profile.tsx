...
const Profile = () => {
	...
	const headers = [
		...
		{key: 'hello',			label: (<>Hello<Icons.Comment className="ml" /></>)},
	] as TabHeader[]
		...
		{key: "address",		label: "",			render: (v:string, i:any) => (
			<div>
				...
				<div className="d-middle gap gray">
					<span className="d-middle warning"><Icons.Heart size={20} /></span>
					<span className="mr-2">0 Likes</span>
					<span className="d-middle"><Icons.Edit className="mr" />6 mins ago</span>
				</div>
			</div>
		)}
	] as TableHeader[]
					...
					<div className="col4">
						<div className="panel">
							<div className="text-align-center">
								<img className="avatar avatar-lg mb" src={Avatar} alt="My Photo" />
								...
								{status.tabKey === 'nametags' && (
									<div>
										<div className="text-align-right">
											<a><b className="d-middle" onClick={()=>setStatus({...status, showDialog: true})}><Icons.FillPlus size={30} />Add</b></a>
										</div>
										<Table 
