	...
	return (
		...
		<div className='verify'>
			<section className='container'>
				<h3 className='text-align-center'>VerifySolc &amp; Publish Contract Source Code</h3>
						...
						status.success ? (
							<>
								<div className='m-b-2' style={{lineHeight: '150%'}}>
									...
									<p className='gray d-middle flex-wrap gap'><Icons.FilledCheck />Note: Contract was created during TxHash# <Link to={`/tx/${status.txId}`}>{status.txId}</Link></p>
									<p className='gray d-middle flex-wrap gap success'><Icons.FilledThumbsUp />Successfully generated ByteCode and ABI for Contract Address <Link to={`/address/${status.address}`}>[{status.address}]</Link></p>
								</div>
								<div className='card'>
									<div className='m-b-2' style={{lineHeight: '150%'}}>
							...
							<>
								<div className='m-b-2' style={{lineHeight: '150%'}}>
									<p className='m-b-1'><strong>Compiler debug log:</strong></p>
									<p className='danger d-middle flex-wrap gap'><Icons.Ban /> Error! Unable to generate Contract ByteCode and ABI</p>
									{status.contractName!=='' && (<p className='gray d-middle flex-wrap gap'><Icons.AngleDobleRight /> Found the following Contrat name in source code: <b>{status.contractName}</b></p>)}
									{/* <p className='gray d-middle flex-wrap'><Icons.AngleDobleRight /> But we were unable to locate a matching bytecode (err_code_2)</p> */}
									<p className='gray d-middle flex-wrap gap'><Icons.FilledExclamationCircle /> For troubleshooting, you can try compiling your source code with the &nbsp;<Link to='https://remix.ethereum.org'>Remix - Solidity IDE</Link>&nbsp; and check for exceptions</p>
								</div>
								<div className="card">
									<div className='m-b-2' style={{lineHeight: '150%'}}>
										Compiler Version: <b>{status.solc}</b><br />
