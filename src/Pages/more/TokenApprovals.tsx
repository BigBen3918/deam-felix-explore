	...
	return (
		<div className="token-approvals">
			<section className="container">
				<h3 className="text-align-center m-b-2">Ethereum Token Approval<br /><small className="gray">Review and revoke your token approvals for an dApp. For more information, check our Knowledge Base <a href="https://info.deam.com/tokenapprovals">article</a></small></h3>
								...
								<div>
									<div className="text-align-right">
										<div className="d-middle" style={{justifyContent: "right"}}>
											...
											<button className="btn gray text-align-left d-middle">Filter<Icons.ChevronDown /></button>
										</div>
									</div>
									<Table
