...
const VerifiedSignatures = () => {
	...
	const fields = [
		...
		{key: "id",			label: "Details",		render: (v:string)=>(<Link className="btn" to={`/verifySig/${v}`}><span className="d-middle">View Signature<Icons.ChevronRight /></span></Link>)},
	] as TableHeader[]
				...
				<div className="panel">
					<div className="panel-header d-middle justify-content-between">
						...
						<div className="d-middle">
							...
							<button className="btn btn-primary"><Icons.Search size={14} /></button>
						</div>
					</div>
					<Table 
						header={(
