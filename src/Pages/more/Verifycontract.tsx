...
import useStore, { CodeFormats, isSolcVersionText, LicenseTypes, loadExternal } from '../../useStore'
...
const VerifyContract = () => {
	...
	React.useEffect(()=>{
		...
		if (address && ethers.utils.isAddress(address)) onChange('address', address)
	}, [])
		...
		<div className='verify'>
			<section className='container'>
				<div className='sub-container'>
					...
					<p className='text-align-center uppercase'><b className='gray'>compiler type and version selection</b></p>
					<hr />
					...
					<div className='form'>
						...
						<div className='text-align-center mt-2 mb-2'>
						...
						<div className='text-align-center mt-2 mb-2 d-center gap'>
