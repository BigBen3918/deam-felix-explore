		...
		{key: "address",		label:"", 	render:(v:string, i:any)=>(
			<div className="card">
				...
				<div className="d-middle">
					...
					{<p className="d-middle"><Icons.FileEarmarkPerson />{i.contractName}</p>}
					{<span className="d-middle"><Icons.Calendar />{(new Date(i.publishDate).toDateString())}</span>}
					<span className="d-middle"><Icons.File />{i.license}</span>
